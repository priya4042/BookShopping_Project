...
namespace BookShopingProject.DataAccess.Migrations
{
    public partial class SPToCoverTypedatatable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE PROCEDURE SP_CoverTypes
                                   As
                                   Select * from CoverTypes");
            migrationBuilder.Sql(@"CREATE PROCEDURE SP_CoverType
                                  @Id int
                                  As
